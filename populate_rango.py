...
def populate():
    ...
    #to add int each Category. Then we will create a dictionary of dictionaries
    #for our categories. This might seem a little bit confusing, but it allows
    #us to iterate through each data structure, and add the data to our models
    ...
    python_pages = [
        ...
        {"title": "Learn Python in 10 Minutes",
         "url": "http://www.korokithakis.net/tutorials/python/", "views": 14} ]
